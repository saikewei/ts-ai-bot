...
3. **多模态推理** — 将音频 + 文本提示发送给支持音频输入的 OpenAI 兼容多模态大模型（如小米 [mimo-v2-omni](https://platform.xiaomimimo.com)，本项目即使用该模型）
...
# 多模态大模型（OpenAI 兼容 API，须支持音频输入；如小米 mimo-v2-omni）
ModelApi:
  LlmKey: "Your key"
  Model: "mimo-v2-omni"
...
| 语音录制 | ✅ | 唤醒后开始，检测静音结束 |
| 多模态 LLM 语音问答 | ✅ | OpenAI 兼容 API，须支持音频输入（如小米 mimo-v2-omni） |
